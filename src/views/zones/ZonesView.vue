<template>
  <section class="zones-page">
    ...
    <article class="data-panel" v-if="selectedZone">
      <div class="panel-head">
        <h3>Tanlangan zona detail</h3>
      </div>
      ...
      <div class="detail-grid">
        ...
        <article class="detail-item">
          <span>Nomi</span>
          <strong>{{ selectedZone.name || 'Nomsiz zona' }}</strong>
        </article>
        <article class="detail-item">
          <span>Rangi</span>
          <strong class="color-strong">
            <span class="dot" :style="{ backgroundColor: selectedZone.color }"></span>
            {{ selectedZone.color }}
          </strong>
        </article>
        <article class="detail-item">
          <span>Kompyuterlar</span>
          <strong>{{ selectedZone.computersCount }}</strong>
        </article>
      </div>

      <p class="detail-description">
        {{ selectedZone.description || 'Bu zonaga tavsif kiritilmagan.' }}
      </p>

      <div class="computer-tags" v-if="selectedZoneComputers.length">
        <span class="computer-tag" v-for="name in selectedZoneComputers" :key="name">
          {{ name }}
        </span>
      </div>
    </article>
    ...
    <article class="data-panel">
      ...
      <div class="detail-grid" v-if="lastResult">
        ...
        <article class="detail-item" v-if="lastResult.color">
          <span>Rangi</span>
          <strong class="color-strong">
            <span class="dot" :style="{ backgroundColor: lastResult.color }"></span>
            {{ lastResult.color }}
          </strong>
        </article>
